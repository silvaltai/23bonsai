...
function AboutSection() {
  return (
    <section className="relative sticky top-0 z-10 bg-[#0c0c0c] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-10 sm:-mt-14 min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-16 sm:py-20 overflow-hidden"
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-8 md:gap-10 text-center z-10">
        <FadeIn delay={0} y={40}>
...
function ServicesSection() {
  return (
    <section className="relative sticky top-0 min-h-screen flex flex-col justify-center z-20 bg-white rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] mt-0 px-5 sm:px-8 md:px-10 py-12 sm:py-14 overflow-hidden"
      style={{ boxShadow: '0 -30px 70px -15px rgba(0,0,0,0.55)' }}>
      <FadeIn delay={0} y={40}>
        <h2 className="font-black uppercase text-center text-[#0c0c0c] mb-5 sm:mb-6 md:mb-6"
          style={{ fontSize: 'clamp(2rem, 7vw, 84px)', letterSpacing: '-0.03em', lineHeight: 1 }}>
          Campaña
        </h2>
      </FadeIn>
...
function PricingSection() {
  return (
    <section id="precios" className="relative md:sticky md:top-0 md:min-h-screen md:flex md:flex-col md:justify-center z-40 bg-[#0a0a0a] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-12 sm:-mt-16 md:mt-0 px-5 sm:px-8 md:px-10 py-16 sm:py-20 md:py-12 md:overflow-hidden"
      style={{ boxShadow: '0 -30px 70px -15px rgba(0,0,0,0.85), inset 0 1px 0 rgba(255,255,255,0.10)' }}>
      <FadeIn delay={0} y={40} className="text-center mb-6 sm:mb-8 md:mb-8">
        <h2 className="hero-heading font-black uppercase" style={{ fontSize: 'clamp(2rem, 7vw, 84px)', letterSpacing: '-0.03em', lineHeight: 1 }}>
          Precios
        </h2>
        <p className="mt-3 font-light text-[#D7E2EA]/50 max-w-xl mx-auto" style={{ fontSize: 'clamp(0.9rem, 1.5vw, 1.15rem)' }}>
  ...
  return (
    <>
      ...
      <main className="relative z-10" style={{ overflowX: 'clip' }}>
        <HeroSection />
        <MarqueeSection />
        {/* Grupo apilable 1: se fijan y apilan, luego se sueltan antes de Ejemplos */}
