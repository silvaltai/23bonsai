...
function AboutSection() {
  return (
    <section className="relative md:sticky md:top-0 z-10 bg-[#0c0c0c] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-10 sm:-mt-14 md:mt-0 min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-24 overflow-hidden"
...
function ServicesSection() {
  return (
    <section className="relative md:sticky md:top-0 md:min-h-screen md:flex md:flex-col md:justify-center z-20 bg-white rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-12 sm:-mt-16 md:mt-0 px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-14"
      style={{ boxShadow: '0 -30px 70px -15px rgba(0,0,0,0.55)' }}>
      <FadeIn delay={0} y={40}>
        <h2 className="font-black uppercase text-center text-[#0c0c0c] mb-8 sm:mb-10 md:mb-10"
          style={{ fontSize: 'clamp(2.4rem, 9vw, 108px)', letterSpacing: '-0.03em', lineHeight: 1 }}>
          Campaña
        </h2>
      </FadeIn>
      <div className="max-w-5xl mx-auto">
        {SERVICES.map((svc, i) => (
          <FadeIn key={svc.num} delay={i * 0.1} y={24}>
            <div className="flex items-start gap-3 sm:gap-4 md:gap-8 py-4 sm:py-5 md:py-5"
              style={{ borderTop: i === 0 ? '1px solid rgba(12,12,12,0.15)' : undefined, borderBottom: '1px solid rgba(12,12,12,0.15)' }}>
              <span className="font-black leading-none shrink-0 text-[#0c0c0c]" style={{ fontSize: 'clamp(2rem, 6.5vw, 82px)', letterSpacing: '-0.04em', lineHeight: 1 }}>
                {svc.num}
              </span>
...
function ProjectsSection() {
  ...
  return (
    <section className="relative z-30 bg-[#0a0a0a] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-12 sm:-mt-16 md:mt-0 px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32"
...
function PricingSection() {
  return (
    <section id="precios" className="relative md:sticky md:top-0 md:min-h-screen md:flex md:flex-col md:justify-center z-40 bg-[#0c0c0c] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-12 sm:-mt-16 md:mt-0 px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-14"
      style={{ boxShadow: '0 -30px 70px -15px rgba(0,0,0,0.8), inset 0 1px 0 rgba(255,255,255,0.10)' }}>
      <FadeIn delay={0} y={40} className="text-center mb-10 sm:mb-12 md:mb-12">
        <h2 className="hero-heading font-black uppercase" style={{ fontSize: 'clamp(2.4rem, 9vw, 104px)', letterSpacing: '-0.03em', lineHeight: 1 }}>
          Precios
        </h2>
