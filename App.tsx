...
const SERVICES = [
  { num: '01', name: 'Videos IA', desc: 'Con hooks claros para captar atención rápido.' },
  { num: '02', name: 'Imágenes publicitarias', desc: 'Piezas visuales creadas para vender, no solo fotos.' },
  { num: '03', name: 'Ángulos de venta', desc: 'Dolor, deseo, beneficio, oferta y comparación.' },
  { num: '04', name: 'Copy de conversión', desc: 'Textos y llamados a la acción pensados para vender.' },
  { num: '05', name: 'Listos para lanzar', desc: 'Formatos listos para Meta Ads y TikTok Ads.' },
]
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-4 sm:px-6 md:px-8 pt-6">
        ...
        <div className="overflow-hidden">
          <FadeIn delay={0.2} y={40}>
            <h1 className="hero-heading font-black uppercase tracking-tight leading-[0.85]">
              <span className="block text-[18vw] sm:text-[16vw] md:text-[13.5vw] lg:text-[12vw] whitespace-nowrap">ANUNCIOS</span>
              <span className="block text-[18vw] sm:text-[16vw] md:text-[13.5vw] lg:text-[12vw] whitespace-nowrap">EFECTIVOS.</span>
            </h1>
          </FadeIn>
        </div>
        ...
        <FadeIn delay={0.35} y={20} className="mt-6 sm:mt-8 md:mt-10 max-w-xl">
          <p className="font-medium leading-snug" style={{ color: '#D7E2EA', fontSize: 'clamp(1rem, 2.2vw, 1.5rem)' }}>
            Videos IA e imágenes publicitarias listas para vender, en 24 horas.
          </p>
        </FadeIn>
      </div>
    ...
    <section className="relative sticky top-0 z-10 bg-[#0c0c0c] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-10 sm:-mt-14 min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-16 sm:py-20 overflow-hidden"
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-8 md:gap-10 text-center z-10 max-w-2xl">
        ...
        <FadeIn delay={0.15} y={24} className="flex flex-col items-center gap-8 sm:gap-10 md:gap-12">
          <p className="font-medium leading-relaxed max-w-[520px]" style={{ color: '#D7E2EA', fontSize: 'clamp(0.95rem, 2vw, 1.3rem)' }}>
            Somos el primer Agente IA de Publicidad. Tu producto entra, tus anuncios salen: videos IA, imágenes y copy listos para vender. No somos Canva. No somos agencia.
          </p>
          <CampaignButton label="Quiero mis anuncios" />
        </FadeIn>
      </div>
...
function PricingSection() {
  return (
    <section id="precios" className="relative md:sticky md:top-0 z-40 bg-[#0a0a0a] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] -mt-12 sm:-mt-16 md:mt-0 px-5 sm:px-8 md:px-10 py-16 sm:py-20 md:py-16"
      ...
      <FadeIn delay={0} y={40} className="text-center mb-8 sm:mb-9 md:mb-10 max-w-xl mx-auto">
        ...
        <p className="mt-3 font-light text-[#D7E2EA]/50" style={{ fontSize: 'clamp(0.85rem, 1.4vw, 1.05rem)' }}>
          Más volumen, más ángulos, más oportunidades de encontrar el anuncio ganador.
        </p>
      </FadeIn>
